...
const CODEX_UPDATE: &str = include_str!("../../hooks/update.js");
const CLAUDE_UPDATE: &str = include_str!("../../hooks/claude-update.js");
const FILE_UTILS: &str = include_str!("../../hooks/fs-utils.js");
const LIFECYCLE: &str = include_str!("../../hooks/linux-lifecycle.js");
