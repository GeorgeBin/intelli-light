...
use intelli_light_linux::led::{Connectivity, GeorgeLightOutput, HttpRequest, HttpTransport};
...
fn path_body(pending: &intelli_light_linux::led::PendingRequest) -> (String, Value) {
